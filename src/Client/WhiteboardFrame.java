...
public class WhiteboardFrame extends JFrame {
	...
	public static void main(String[] args) {
		...
		new WhiteboardFrame(fileToOpen);
        
	}
	
	private int nextId;
	
	private boolean forServerUseOnly = true;
	...
	public WhiteboardFrame(File file) {
		isServer = false;
		isClient = false;
		nextId = 0;
		...
		// SAVE AND OPEN PANEL
			...
			imageButton.addActionListener( new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					int status = chooser.showSaveDialog(WhiteboardFrame.this);
	...
	// SET UP THE FRAME
		...
		canvas = new CanvasPanel(500, 400, this, myModel, status);
