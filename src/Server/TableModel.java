...
public class TableModel extends AbstractTableModel implements ModelListener{
	...
	public TableModel(String[] colNames, Whiteboard parentFrame) {
	...
	public int getRowCount() {
		return parentFrame.getCanvas().getShapesList().size();
	}
	...
	public Object getValueAt(int row, int col) {
		...
		List<DShape> shapes = parentFrame.getCanvas().getShapesList();
